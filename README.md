...
<table>
  <tr>
    <td align="center" width="25%">
      <sub>MERGED</sub><br/>
      <strong><!-- ext-merged -->167<!-- /ext-merged --></strong><br/>
      <sub>across <!-- ext-merged-repos -->126<!-- /ext-merged-repos --> external repos</sub>
    </td>
    <td align="center" width="25%">
      <sub>OPEN</sub><br/>
...
<table>
  ...
  <tr>
    <td align="center" width="25%">
      ...
      <sub>merged PRs across <!-- ext-merged-repos -->126<!-- /ext-merged-repos --><br/>external public repos</sub>
    </td>
    <td align="center" width="25%">
      <sub>PACKAGES</sub><br/>
