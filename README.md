...
<sub>Across <strong><!-- ext-unique-repos -->497<!-- /ext-unique-repos --> unique external repos</strong> (excluding my own). Source: GitHub search API, <code>author:MukundaKatta is:pr -user:MukundaKatta</code>. Last refreshed <!-- ext-refresh-date -->2026-06-25<!-- /ext-refresh-date -->.</sub>

<table>
  <tr>
    <td align="center" width="25%">
      <sub>MERGED</sub><br/>
      <strong><!-- ext-merged -->181<!-- /ext-merged --></strong><br/>
      <sub>across <!-- ext-merged-repos -->134<!-- /ext-merged-repos --> external repos</sub>
    </td>
    <td align="center" width="25%">
      <sub>OPEN</sub><br/>
      <strong><!-- ext-open -->339<!-- /ext-open --></strong><br/>
      <sub>awaiting review / response</sub>
    </td>
    <td align="center" width="25%">
      <sub>CLOSED</sub><br/>
      <strong><!-- ext-closed -->461<!-- /ext-closed --></strong><br/>
      <sub>not merged</sub>
    </td>
    <td align="center" width="25%">
...
_Last refreshed 2026-06-25 from npm, PyPI, and the GitHub API._
...
<table>
  ...
  <tr>
    <td align="center" width="25%">
      ...
      <sub>merged PRs across <!-- ext-merged-repos -->134<!-- /ext-merged-repos --><br/>external public repos</sub>
    </td>
    <td align="center" width="25%">
      <sub>PACKAGES</sub><br/>
